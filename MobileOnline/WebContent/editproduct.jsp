...
System.out.println(temp.getPid()+" "+temp.getPname()+" "+temp.getCategory()+" "+temp.getBrand()+" "+temp.getRam()+" "+temp.getRom()+" "+temp.getProcessor()+" "+temp.getBattery()+" "+temp.getPrice()+" "+temp.getDescrptn());
%>
<%
